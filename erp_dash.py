	...
	def update_data(data_f1, data_f2):
		...
		for i in data_f1.iterrows():
			if i[1]["Material Description"] == "500mL Spritz":
				if i[1]['Goods'][0] == 1:
					temp_df1.loc[(temp_df1['Round'] == 1) & (temp_df1['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				elif i[1]['Goods'][0] == 2:
					temp_df1.loc[(temp_df1['Round'] == 2) & (temp_df1['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				elif i[1]['Goods'][0] == 3:
					temp_df1.loc[(temp_df1['Round'] == 3) & (temp_df1['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				else:
				...
				if i[1]['Goods'][0] == 1:
					temp_df2.loc[(temp_df2['Round'] == 1) & (temp_df2['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				elif i[1]['Goods'][0] == 2:
					temp_df2.loc[(temp_df2['Round'] == 2) & (temp_df2['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				elif i[1]['Goods'][0] == 3:
					temp_df2.loc[(temp_df2['Round'] == 3) & (temp_df2['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				else:
				...
				if i[1]['Goods'][0] == 1:
					temp_df3.loc[(temp_df3['Round'] == 1) & (temp_df3['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				elif i[1]['Goods'][0] == 2:
					temp_df3.loc[(temp_df3['Round'] == 2) & (temp_df3['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				elif i[1]['Goods'][0] == 3:
					temp_df3.loc[(temp_df3['Round'] == 3) & (temp_df3['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				else:
				...
				if i[1]['Goods'][0] == 1:
					temp_df4.loc[(temp_df4['Round'] == 1) & (temp_df4['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				elif i[1]['Goods'][0] == 2:
					temp_df4.loc[(temp_df4['Round'] == 2) & (temp_df4['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				elif i[1]['Goods'][0] == 3:
					temp_df4.loc[(temp_df4['Round'] == 3) & (temp_df4['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				else:
				...
				if i[1]['Goods'][0] == 1:
					temp_df5.loc[(temp_df5['Round'] == 1) & (temp_df5['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				elif i[1]['Goods'][0] == 2:
					temp_df5.loc[(temp_df5['Round'] == 2) & (temp_df5['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				elif i[1]['Goods'][0] == 3:
					temp_df5.loc[(temp_df5['Round'] == 3) & (temp_df5['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				else:
				...
				if i[1]['Goods'][0] == 1:
					temp_df6.loc[(temp_df6['Round'] == 1) & (temp_df6['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				elif i[1]['Goods'][0] == 2:
					temp_df6.loc[(temp_df6['Round'] == 2) & (temp_df6['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']		
				elif i[1]['Goods'][0] == 3:
					temp_df6.loc[(temp_df6['Round'] == 3) & (temp_df6['Day'] == int(i[1]['Goods'][3])), 'Qty'] -= i[1]['Quantity']
				else:
