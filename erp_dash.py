...
if file is not None:
    ...
    def profit_product(data_f):
        ...
        if len(data_f['Round'].unique()) == 1:
            ...
            chart_2.update_layout(annotations=[dict(text='Round 1', x=0.2, y=0.5, font_size=20, showarrow=False),
                                               dict(text='Round 2', x=0.8, y=0.5, font_size=20, showarrow=False)])
        else:
            df_1 = data_f.loc[data_f['Round'] == 1]
            df_2 = data_f.loc[data_f['Round'] == 2]
