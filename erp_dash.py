...
if file is not None:
    ...
    def round_first(data_f):
        ...
        if option == 'Round 1':
            ...
            inventory_4 = {'1L Lemon Spritz' : [lsp1]}
            inventory_5 = {'1L ClearPure': [p1]}
            sorted_data_f = sorted_data_f.loc[(sorted_data_f['Round' == 2])]
            ...
            inventory_4 = {'1L Lemon Spritz' : [lsp1]}
            inventory_5 = {'1L ClearPure': [p1]}
            sorted_data_f = sorted_data_f.loc[(sorted_data_f['Round' == 3])]
    ...
    if re_ord == "Yes":
        ...
        new_data.loc[day_5_spritz, '500mL Spritz'] = new_data.loc[day_5_spritz, '500mL Spritz'] + ml_5_spritz
