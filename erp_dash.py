...
# 			submit_button = st.form_submit_button(label='Submit')
		...
		if len(df['Round'].unique()) == 1:
			...
			df.loc[day_5_spritz - 1,'500mL Spritz'] = df.loc[day_5_spritz - 1,'500mL Spritz'] - (ml_5_spritz*24)
			df.loc[day_5_lemspritz - 1,'500mL Lemon Spritz'] = df.loc[day_5_lemspritz - 1,'500mL Spritz'] + (ml_5_lemspritz*24)
			df.loc[day_5_pure - 1,'500mL ClearPure'] = df.loc[day_5_pure - 1,'500mL Lemon Spritz'] - (ml_5_pure*24)
			df.loc[day_1_spritz - 1,'1L Spritz'] = df.loc[day_1_spritz - 1,'500mL ClearPure'] - (l_1_spritz*12)
			df.loc[day_1_lemspritz - 1,'1L Lemon Spritz'] = df.loc[day_1_lemspritz - 1,'1L Lemon Spritz'] + (l_1_lemspritz*12)
			df.loc[day_1_pure - 1,'1L ClearPure'] = df.loc[day_1_pure - 1,'1L ClearPure'] - (l_1_pure*12)
